...
export default class warehouse extends React.Component {
  ...
  getData() {
    axios.get("http://localhost:5000/warehouse").then((res) => {
      ...
      tempList.sort((a, b) =>
        a.ptype > b.ptype ? 1 : b.ptype > a.ptype ? -1 : 0
      );
      this.setState({
        ...
        () => {
          storage
            ...
            .then((url) => {
              ...
              axios
                .post(
                  "http://localhost:5000/warehouse/productList/add",
                  productData
                )
                .then((res) => {
                    ...
                    <div className="newProduct">
                      <form>
                        <div className="black-text">
                          ...
                          >
                            <option value="e-device" defaultValue>
                              E-devices
                            </option>
